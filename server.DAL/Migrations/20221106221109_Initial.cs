    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quastionnaires", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Quastionnaires_QuestionnaireId",
                        column: x => x.QuestionnaireId,
                        principalTable: "Quastionnaires",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Maxim", "Maxim1" });
